...
export default function Process() {
  ...
  const steps = [
    ...
    {
      icon: (
        <FaPencilRuler className="text-green-400" />
      ),
      title: "Design",
      desc: "Wireframes and visual designs crafted for usability, clarity, and strong user experience.",
    },
    ...
    {
      icon: (
        <FaVial className="text-green-400" />
      ),
      title: "Testing & Quality Assurance",
      desc: "Comprehensive testing ensures reliability, performance, and a bug-free user experience.",
    },
  ...
  return (
    <section
      id="process"
      aria-labelledby="process-heading"
      className="overflow-hidden bg-white dark:bg-black py-20 lg:py-28 transition-colors"
    >
            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                >
                  ...
                  <p className="mt-2 text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed break-words">
                    {step.desc}
                  </p>
