...
export default function Process() {
  ...
  return (
    <section
      id="process"
      aria-labelledby="process-heading"
      className="bg-white dark:bg-black py-20 lg:py-28 transition-colors w-full"
    >
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        {/* TIMELINE */}
        <ol className="mt-16 relative w-full max-w-[1200px] mx-auto">
            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <motion.div
                  animate={{ scale: [1, 1.08, 1] }}
                  transition={{ duration: 2, repeat: Infinity }}
                  className="flex items-center justify-center w-14 h-14 rounded-full bg-gray-100 dark:bg-white/10 text-black dark:text-white text-xl border border-gray-200 dark:border-white/10 flex-shrink-0"
                  aria-hidden="true"
                >
                  {step.icon}
                </motion.div>
